...
[Documentação](https://github.com/Interpretador-Musical/Grupo03-COMP01/blob/main/docs/documentacao.md)
[Roadmap](https://github.com/Interpretador-Musical/Grupo03-COMP01/blob/main/docs/roadmap.md)
...
flowchart LR
  ...
  C -- AST --> D["Compilador<br/>tree-walking"]
...
O conceito central deste compilador é o **playhead**: um cursor de tempo que avança conforme as instruções são validadas na Árvore Sintática. Agendar uma nota não bloqueia a execução — apenas insere um evento na posição atual do cursor e o empurra para a frente.
...
A palavra-chave `por` é obrigatória. Sem ela, a instrução `toca la4 - 2 tempo` geraria conflitos de ambiguidade semântica no Bison. Com o separador, ambos os lados aceitam operações matemáticas complexas sem conflitos de shift/reduce.
...
O desenvolvimento técnico agora foca-se na expansão semântica (condicionais e funções) e na calibração de efeitos sonoros.
